...
<form method="post" action="Modifycustomerdetails.do">
...
String account=(String)session.getAttribute("acnumber");
System.out.println("session value  " +account);
...
account=(String)session.getAttribute("accountnumber");
System.out.println(account);
rs=st.executeQuery("select * from customerdetails where accountnumber='"+account+"'");
System.out.println("if  loooppp");
}
else
{
...
System.out.println("else  loooppp");
}
 ...
 %>
  ...
  <table border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="65%" id="AutoNumber1">
    ...
    <tr>
      ...
      NAME</td>
      <td width="50%"><input type="text" name="name" value=<%=rs.getString(1) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      DATE OF&nbsp;&nbsp; BIRTH  </td>
      <td width="50%"><input type="text" name="dob" value=<%=rs.getString(2) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      AGE</td>
      <td width="50%"><input type="text" name="age" value=<%=rs.getString(3) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <input type="radio"  name="gender"  value="female">FEMALE</td>
       <% }else{%>
     <td width="50%">  <input type="radio" value="male"   name="gender">MALE <input type="radio" checked name="gender"  value="female">FEMALE
   </td>
  <% }%>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ADDRESS</td>
      <td width="50%"><textarea rows="2" name="address" cols="20"> 	<%=rs.getString(5) %> </textarea></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      OCCUPATION</td>
      <td width="50%"><input type="text" name="occupation" value=<%=rs.getString(6) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ACCOUNT TYPE</td>
      ...
      {%>
      <td width="50%"><input type="radio" checked name="acctype" value="current">current<input type="radio" name="acctype" value="saving">saving
      <%}else{ %>
        <td width="50%"><input type="radio" name="acctype" value="current">current<input type="radio" checked name="acctype" value="saving">saving</td>
    <%} %>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <td width="50%"><input type="text" name="contact"  value=<%=rs.getString(8) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>
  ...
  <table border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="64%" id="AutoNumber2" bordercolorlight="#000000">
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Account
      number</td>
      <td width="50%"><input type="text" name="accnumber" value=<%=rs.getString(9) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Account
      </td>
      <td width="50%"><input type="text" name="amount" value=<%=rs.getString(10) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; password</td>
      <td width="50%"><input type="password" name="password" value=<%=rs.getString(11) %> size="20"></td>
    </tr>
    <tr>
      <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; conform&nbsp;
      password</td>
      <td width="50%"><input type="password" name="cpassword" value=<%=rs.getString(12)%> size="20"></td>
    </tr>
  </table>
  <% }%>
  <p>&nbsp;</p>
